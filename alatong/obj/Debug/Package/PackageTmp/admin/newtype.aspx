<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newtype.aspx.cs" Inherits="web1.admin.newtype" %>
...
<TABLE border=0 cellSpacing=1 cellPadding=3 width="95%" bgColor=#6298e1 align="center">
  ...
  <TR>
    <TD height=24 noWrap colspan="2"><FONT color=#ffffff><IMG border=0 align=absMiddle 
      ...
      height=18>&nbsp;<STRONG>新闻分类：添加，修改新闻分类相关的内容</STRONG></FONT></TD></TR>
  <TR>
    <TD bgColor=#ebf2f9 height=24 noWrap align=left>　<A href="newtype_add.aspx">添加新闻分类</A><FONT 
      color=#0000ff></TD>
   <td bgColor=#ebf2f9 height=24 noWrap align="middle" width="300" valign="middle">快速搜索：<asp:TextBox ID="tbKeyWord" runat="server"></asp:TextBox>
       <input type="button" id="btSearch" name="btSearch" name="btSearch" value="搜索" onclick="window.location.href='newtype.aspx?keyword='+MM_findObj('tbKeyWord').value" />
      </td>   
