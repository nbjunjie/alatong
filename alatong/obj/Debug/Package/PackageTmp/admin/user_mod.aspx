<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_mod.aspx.cs" Inherits="webshop.admin.user_mod" %>
...
<body>
    ...
    <tr>
      <th height="22" colspan="2" sytle="line-height:150%">【修改会员信息】</th>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
      ...
      <td width="80%" class="forumrowhighlight">
         <asp:Panel ID="plbt" runat="server">
      <asp:Button ID="Button1" runat="server" Text="审核确认" onclick="Button1_Click" />
      </asp:Panel>
        </td>
    </tr>
    <tr>
