<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="new_mod.aspx.cs" Inherits="web1.admin.new_mod" %>
...
<body>
    ...
    <tr>
      <th height="22" colspan="2" sytle="line-height:150%">【修改新闻信息】</th>
    </tr>
    <tr>
    ...
    <tr style="display:none;">
      ...
      <td width="80%" class="forumrowhighlight">
          ...
          <br />
          <asp:Literal ID="lbDoc" runat="server"></asp:Literal>
          <br />
