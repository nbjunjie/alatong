<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paytype.aspx.cs" Inherits="webshop.admin.paytype" %>
...
<TABLE border=0 cellSpacing=1 cellPadding=3 width="95%" bgColor=#6298e1 align="center">
  ...
  <TR>
    <TD height=24 noWrap colspan="2"><FONT color=#ffffff><IMG border=0 align=absMiddle 
      ...
      height=18>&nbsp;<STRONG>支付类型管理：添加，修改支付类型信息</STRONG></FONT></TD></TR>
  <TR>
   ...
   <td bgColor=#ebf2f9 height=24 noWrap align="middle" width="300" valign="middle">快速搜索：<asp:TextBox ID="tbKeyWord" runat="server"></asp:TextBox>
       <input type="button" id="btSearch" name="btSearch" name="btSearch" value="搜索" onclick="window.location.href='paytype.aspx?keyword='+MM_findObj('tbKeyWord').value" />
      </td>   
        ...
        <asp:TableRow ID="TableRow1" runat="server" BackColor="#8DB5E9" Font-Bold="True" 
            ...
            <asp:TableCell ID="TableCell4" runat="server" Width="80">名称</asp:TableCell>
            <asp:TableCell ID="TableCell5" runat="server">简介</asp:TableCell>
