<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="pro_add.aspx.cs" Inherits="web1.admin.pro_add" %>
...
<body>
    ...
    <tr>
      <th height="22" colspan="2" sytle="line-height:150%">【添加产品信息】</th>
    </tr>
    <tr>
    ...
    <tr style="display:none;">
      <td width="20%" align="right" class="forumrow">实际价格：</td>
      <td width="80%" class="forumrowhighlight">
