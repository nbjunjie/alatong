<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="web1.admin.products" %>
...
<TABLE border=0 cellSpacing=1 cellPadding=3 width="95%" bgColor=#6298e1 align="center">
  ...
  <TR>
    <TD height=24 noWrap colspan="2"><FONT color=#ffffff><IMG border=0 align=absMiddle 
      ...
      height=18>&nbsp;<STRONG>产品信息：添加，修改产品以及产品分类相关的内容</STRONG></FONT></TD></TR>
  <TR>
    <TD bgColor=#ebf2f9 height=24 noWrap align=left>　<A href="protype.aspx">管理产品分类</A><FONT 
      color=#0000ff>&nbsp;|&nbsp;</FONT><A href="pro_add.aspx">添加产品</A></TD>
   <td bgColor=#ebf2f9 height=24 noWrap align="middle" width="500" valign="middle">产品分类：<asp:DropDownList 
           ID="ddlType" runat="server">
       </asp:DropDownList>　快速搜索：<asp:TextBox ID="tbKeyWord" runat="server"></asp:TextBox>
       <input type="button" id="btSearch" name="btSearch" name="btSearch" value="搜索" onclick="window.location.href='products.aspx?TypeID='+form1.ddlType.options[ddlType.selectedIndex].value+'&keyword='+MM_findObj('tbKeyWord').value" />
      </td>   
        ...
        <asp:TableRow ID="TableRow1" runat="server" BackColor="#8DB5E9" Font-Bold="True" 
            ...
            <asp:TableCell ID="TableCell3" runat="server" Width="30">推荐</asp:TableCell>
            <asp:TableCell ID="TableCell4" runat="server" Width="80">所属分类</asp:TableCell>
            <asp:TableCell ID="TableCell5" runat="server">产品名称</asp:TableCell>
