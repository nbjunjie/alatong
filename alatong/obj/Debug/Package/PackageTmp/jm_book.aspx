<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jm_book.aspx.cs" Inherits="alatong.jm_book" %>
...
<div class="main clearfix floatcenter">
	...
	<div class="about_right">
		...
		<div class="book_list clearfix">
			<div class="book_list_t clearfix">
                <asp:literal id="lbInfo11" runat="server" />
            </div>
