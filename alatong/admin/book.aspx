<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="book.aspx.cs" Inherits="rsdc.admin.book" %>
...
<TABLE border=0 cellSpacing=1 cellPadding=3 width="95%" bgColor=#6298e1 align="center">
  ...
  <TR>
    <TD height=24 noWrap colspan="2"><FONT color=#ffffff><IMG border=0 align=absMiddle 
      ...
      height=18>&nbsp;<STRONG>问答信息：查看和删除客户问答内容。</STRONG></FONT></TD></TR>
  <TR>
    <TD bgColor=#ebf2f9 height=24 noWrap align=left><A href="book_add.aspx">添加FAQ</A></TD>
   <td bgColor=#ebf2f9 height=24 noWrap align="middle" width="450" valign="middle">快速搜索：<asp:TextBox ID="tbKeyWord" runat="server"></asp:TextBox>
       <input type="button" id="btSearch" name="btSearch" name="btSearch" value="搜索" onclick="window.location.href='book.aspx?Type='+form1.ddlBookType.options[ddlBookType.selectedIndex].value+'&keyword='+MM_findObj('tbKeyWord').value" />
      </td>   
        ...
        <asp:TableRow ID="TableRow1" runat="server" BackColor="#8DB5E9" Font-Bold="True" 
            ...
            <asp:TableCell ID="TableCell4" runat="server" Width="30">显示</asp:TableCell>
            <asp:TableCell ID="TableCell2" runat="server" Width="200">标题</asp:TableCell>
            <asp:TableCell ID="TableCell3" runat="server">内容</asp:TableCell>
