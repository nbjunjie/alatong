<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_mod.aspx.cs" Inherits="nb_xy.admin.admin_mod" %>
...
<body>
    <form id="form1" runat="server" onsubmit="return checkAdminMod(form1);"><br/>
    <table class="tableborder" width="95%" border="0" align="center" cellpadding="5" cellspacing="1">
    <tr>
      <th height="22" colspan="2" sytle="line-height:150%">【修改管理员信息】</th>
    </tr>
    <tr>
