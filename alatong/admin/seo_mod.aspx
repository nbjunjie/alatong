<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seo_mod.aspx.cs" Inherits="web1.admin.seo_mod" %>
...
<body>
    ...
    <tr>
      <th height="22" colspan="2" sytle="line-height:150%">【修改SEO信息】</th>
    </tr>
    <tr>
      <td width="20%" align="right" class="forumrow">页面名称：</td>
      <td width="80%" class="forumrowhighlight"><asp:Label ID="lbPageName" runat="server" Text=""></asp:Label></td>
    </tr>
    <tr>
