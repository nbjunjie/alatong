    ...
    public partial class seo : System.Web.UI.Page
    {
        ...
        private void DelData()
        {
            ...
            if (FunctionClass.CheckStr(strDel, 1))
            {
                ...
                myData.ExecuteSql("delete from T_Seo where ID=" + strDel, myConn);
        ...
        void myTbDel_Click(object sender, EventArgs e)
        {
            ...
            strKeyWord = Request.QueryString["KeyWord"];
            strSql = "select ID from T_Seo where 1=1";
            ...
            for (int i = 0; i < myDs.Tables[0].Rows.Count; i++)
            {
                ...
                {
                    if (myTB.Checked)
                        myData.ExecuteSql("delete from T_Seo where ID=" + strRowID, myConn);
                }
            }
            myDs.Dispose();
