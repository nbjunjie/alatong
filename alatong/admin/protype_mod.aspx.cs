...
{
    public partial class protype_mod : System.Web.UI.Page
    {
        ...
        {
            string strPID, strTypeCalled, strIsShow, strSql, strID, strContent;
            ...
            strSql = "update T_ProType set PID=@PID,TypeCalled=@TypeCalled,IsShow=@IsShow,Memo=@Memo where ID=@ID";
            string[] ParamsName = new string[] { "@PID", "@TypeCalled", "@IsShow","@Memo","@ID" };
            string[] ParamsValue = new string[] { strPID, strTypeCalled, strIsShow,strContent,strID };
